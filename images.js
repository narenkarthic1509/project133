...
function draw(){
    ...
    if(statusofcoco != ""){
        for(i = 0; i < object.length; i++){
            ...
            document.getElementById("object").innerHTML = "the image has 5 objects easily visible and cocossd has detected 1 object which is wrong and not shown but if check console";
